...
export default function Landing() {
      ...
      try {
        ...
        const normalized = data
          ...
          .map((item) => {
            ...
            const label = addr.city || addr.town || addr.village || item.display_name.split(",")[0];
            return { label, full: item.display_name, score: getSimilarity(label, query) };
          })
          .sort((a, b) => b.score - a.score);

        if (!controller.signal.aborted) setLocationSuggestions(normalized);
      } catch {
  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden">
      {/* ── HERO ── */}
      <section className="relative w-full px-4 py-12 sm:px-6 lg:px-8 lg:py-20 overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-7xl w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start lg:items-center w-full">
            ...
            <div className="w-full flex flex-col">
              ...
              >
                <form
                  ...
                  className="flex flex-col gap-3 rounded-2xl border border-gray-100 bg-white p-4 sm:p-5 shadow-lg w-full"
                >
                  {/* Inputs Row */}
                  <div className="flex flex-col sm:flex-row gap-2 w-full">
                    ...
                    <div className="relative flex-1 w-full">
                      <div className="flex items-center gap-2 rounded-xl bg-gray-50 px-3 py-2.5">
                        ...
                        />
                        {search && (
                          <button type="button" onClick={() => setSearch("")} className="text-gray-400 hover:text-gray-600 text-xs">
                            ✕
                          </button>
                        )}
                      </div>
                      ...
                      <AnimatePresence>
                        {showSuggestions && suggestions.length > 0 && (
                          <motion.div
                            ...
                            animate={{ opacity: 1, y: 0 }}
                            exit={{ opacity: 0, y: -8 }}
                            className="absolute top-full left-0 right-0 mt-1 bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden z-50 max-h-64 overflow-y-auto"
                          >
                    ...
                    <div className="relative w-full sm:w-40">
                      <div className="flex items-center gap-2 rounded-xl bg-blue-50 px-3 py-2.5 border border-blue-100">
                        ...
                        />
                        {location && (
                          <button type="button" onClick={() => setLocation("")} className="text-blue-300 hover:text-blue-500 text-xs">
                            ✕
                          </button>
                        )}
                      </div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-2 w-full">
                    <button
                      type="submit"
                      className="flex-1 bg-gradient-to-r from-teal-500 to-blue-500 text-white px-5 py-2.5 rounded-xl font-bold text-sm hover:opacity-90 transition"
                    >
                      Search
                    </button>
                    <button
            ...
            >
              ...
              {/* Floating Card - Separated Below Image */}
              <div className="mt-6 w-full max-w-xs">
                <div className="bg-white rounded-2xl shadow-xl p-4 border border-gray-100">
                  ...
                  <div className="flex items-center gap-2 mt-2 text-xs">
                    ...
                    <span className="ml-auto bg-green-100 text-green-600 font-bold px-2 py-0.5 rounded-full">Open</span>
                  </div>
                </div>
              </div>
            </motion.div>
          ...
          <div className="overflow-hidden rounded-2xl border border-gray-100 shadow-sm">
            ...
            {COMPARISON_ROWS.map((row, i) => (
              <motion.button
                ...
                className={`grid w-full grid-cols-5 px-5 py-4 text-left text-sm hover:bg-teal-50 transition ${
