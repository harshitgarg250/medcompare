...
function HospitalsMap({ hospitals, userLocation, onHospitalClick, onRealHospitalClick }) {
  ...
  return (
    ...
    >
      ...
      <FetchRealHospitals center={userLocation} onFetch={setRealHospitals} />
      ...
      {realHospitals.map((h) => {
        ...
        return (
          <Marker
            ...
            eventHandlers={{
              click: () => onRealHospitalClick && onRealHospitalClick(h),
            }}
          >
            <Popup>
              <div style={{ minWidth: "160px" }}>
                ...
                >
                  {h.tags?.amenity === "hospital"
                    ? "Hospital"
                    : h.tags?.amenity === "clinic"
                      ? "Clinic"
                      : "Medical Center"}
                </div>
                {h.tags?.["addr:street"] && (
